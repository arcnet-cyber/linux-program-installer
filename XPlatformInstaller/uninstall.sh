...
if grep -q "alias $ALIAS_NAME=" "$BASHRC"; then
    ...
    # Use sed to remove the exact alias line
...
read -rp "Do you want to delete the project directory at $SCRIPT_DIR? (y/n): " DELETE_PROJECT
DELETE_PROJECT=${DELETE_PROJECT,,} # to lowercase

if [[ "$DELETE_PROJECT" == "y" ]]; then
    read -rp "Are you sure? This will permanently delete: $SCRIPT_DIR (y/n): " CONFIRM_DELETE
